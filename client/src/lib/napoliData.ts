...
export const RESTAURANT_INFO = {
  ...
  phone: "725-204-0379",
  website: "www.NapoliPizzeria.com",
  instagram: "@napolispizzeria_lv",
  facebook: "@THE ORIGINAL NAPOLI'S PIZZERIA",
  hours: [
    { days: "Sunday – Tuesday", time: "10:00AM – 10:00PM" },
    { days: "Friday – Saturday", time: "10:00AM – 11:00PM" },
  ],
...
export const SUBS = {
  ...
  hotDetailed: [
    { name: "Buffalo Chicken Breast", add: "Cheese" },
    { name: "Crispy Chicken", add: "Cheese" },
    { name: "Grilled Sausage & Peppers" },
    { name: "Fried Chicken", add: "Cheese" },
    { name: "California Turkey", add: "$1" },
    { name: "Philly Steak Bomb", add: "$2", desc: "Crispy Onions, Cheesy Mustard, Bacon, Cheddar" },
    { name: "Watertown" },
    { name: "Newton" },
    { name: "Meatball Parmigiana Subs" },
    { name: "Meatball & Sausage Parmigiana" },
    { name: "Eggplant Parmigiana" },
    { name: "Beef or Chicken Philly" },
  ],
};
