...
export interface NutritionInfo {
  ...
  carbs?: number;     // approximate grams of carbohydrates
  tags?: DietTag[];
  allergens?: Allergen[];
}
...
export const NUTRITION: Record<string, NutritionInfo> = {
  ...
  // ── APPETIZERS ──────────────────────────────────────────────
  "Napoli's Combo Platter":        { cal: 980,  protein: 22, carbs: 82,  tags: ["V"],         allergens: ["wheat", "milk", "eggs"] },
  "French Fries":                  { cal: 320,  protein: 4,  carbs: 42,  tags: ["V", "VG", "GF", "DF"] },
  "Garlic Bread":                  { cal: 260,  protein: 5,  carbs: 36,  tags: ["V"],         allergens: ["wheat", "milk"] },
  "Bread Sticks (12)":             { cal: 480,  protein: 12, carbs: 68,  tags: ["V"],         allergens: ["wheat", "milk"] },
  "Curly Fries":                   { cal: 380,  protein: 4,  carbs: 52,  tags: ["V"],         allergens: ["wheat"] },
  "Garlic Balls w/ Cheese (20)":   { cal: 420,  protein: 14, carbs: 48,  tags: ["V"],         allergens: ["wheat", "milk"] },
  "Breaded Mushrooms (12)":        { cal: 340,  protein: 8,  carbs: 38,  tags: ["V"],         allergens: ["wheat", "eggs"] },
  "Fried Ravioli (8)":             { cal: 460,  protein: 16, carbs: 50,  tags: ["V"],         allergens: ["wheat", "milk", "eggs"] },
  "Zucchini Sticks (12)":          { cal: 310,  protein: 7,  carbs: 34,  tags: ["V"],         allergens: ["wheat", "eggs"] },
  "Jalapeño Poppers (6)":          { cal: 380,  protein: 9,  carbs: 36,  tags: ["V", "HOT"],  allergens: ["wheat", "milk", "eggs"] },
  "Cheese Quesadilla":             { cal: 520,  protein: 18, carbs: 48,  tags: ["V"],         allergens: ["wheat", "milk"] },
  "Chili Cheese Fries":            { cal: 680,  protein: 22, carbs: 58,  allergens: ["wheat", "milk"] },
  "Bruschetta":                    { cal: 280,  protein: 6,  carbs: 38,  tags: ["V"],         allergens: ["wheat"] },
  "Curly Fries W/ Bacon":          { cal: 520,  protein: 14, carbs: 52,  allergens: ["wheat", "milk"] },
  "Onion Rings":                   { cal: 410,  protein: 5,  carbs: 50,  tags: ["V"],         allergens: ["wheat", "eggs"] },
  ...
  "Spaghetti & Sausage":           { cal: 680,  protein: 30, carbs: 78,  allergens: ["wheat", "milk"] },
  "Baked Ziti":                    { cal: 760,  protein: 32, carbs: 88,  tags: ["V"],         allergens: ["wheat", "milk", "eggs"] },
  "Ziti w/ Marinara":              { cal: 560,  protein: 18, carbs: 76,  tags: ["V"],         allergens: ["wheat", "milk"] },
  "Chicken Parmigiana":            { cal: 820,  protein: 48, carbs: 72,  tags: ["BEST"],      allergens: ["wheat", "milk", "eggs"] },
  "Homemade Shells":               { cal: 640,  protein: 28, carbs: 68,  tags: ["V"],         allergens: ["wheat", "milk", "eggs"] },
  "Manicotti w/ Ricotta & Egg":    { cal: 680,  protein: 30, carbs: 72,  tags: ["V"],         allergens: ["wheat", "milk", "eggs"] },
  "Cannelloni":                    { cal: 660,  protein: 28, carbs: 70,  allergens: ["wheat", "milk", "eggs"] },
  "Fettuccine Alfredo":            { cal: 780,  protein: 22, carbs: 86,  tags: ["V"],         allergens: ["wheat", "milk", "eggs"] },
  "Chicken Fettuccine Alfredo":    { cal: 920,  protein: 46, carbs: 84,  allergens: ["wheat", "milk", "eggs"] },
  "Shrimp & Chicken Fettuccine Alfredo": { cal: 980, protein: 52, carbs: 82, allergens: ["wheat", "milk", "eggs", "shellfish"] },
  "Stuffed Shells w/ Ricotta":     { cal: 640,  protein: 28, carbs: 66,  tags: ["V"],         allergens: ["wheat", "milk", "eggs"] },
  "Creamy Butter Ravioli":         { cal: 620,  protein: 22, carbs: 72,  tags: ["V"],         allergens: ["wheat", "milk", "eggs"] },
  "Marinara Ravioli":              { cal: 560,  protein: 20, carbs: 70,  tags: ["V"],         allergens: ["wheat", "milk", "eggs"] },
  "Baked Ravioli":                 { cal: 680,  protein: 26, carbs: 74,  tags: ["V"],         allergens: ["wheat", "milk", "eggs"] },
  "Ravioli Bolognese (Sauteed)":   { cal: 720,  protein: 30, carbs: 76,  allergens: ["wheat", "milk", "eggs"] },
  "Spaghetti w/ Marinara":         { cal: 480,  protein: 14, carbs: 80,  tags: ["V"],         allergens: ["wheat"] },
  "Tortellini w/ Marinara":        { cal: 580,  protein: 22, carbs: 74,  tags: ["V"],         allergens: ["wheat", "milk", "eggs"] },
  "Tortellini Ala Parma":          { cal: 640,  protein: 26, carbs: 72,  allergens: ["wheat", "milk", "eggs"] },
  "Tortellini Alfredo":            { cal: 720,  protein: 26, carbs: 78,  tags: ["V"],         allergens: ["wheat", "milk", "eggs"] },
  "Alfredo, Chicken, Garlic & Broccoli": { cal: 860, protein: 44, carbs: 76, allergens: ["wheat", "milk", "eggs"] },
  "Eggplant Parmigiana":           { cal: 580,  protein: 18, carbs: 62,  tags: ["V"],         allergens: ["wheat", "milk", "eggs"] },

  // ── SUBS & SANDWICHES ────────────────────────────────────────
  "Napoli Italian Special":        { cal: 680,  protein: 32, carbs: 58,  allergens: ["wheat", "milk"] },
  "Ham & Cheese":                  { cal: 580,  protein: 28, carbs: 52,  allergens: ["wheat", "milk"] },
  "Fried Chicken":                 { cal: 620,  protein: 34, carbs: 54,  allergens: ["wheat", "eggs"] },
  "Turkey & Cheese":               { cal: 540,  protein: 30, carbs: 50,  allergens: ["wheat", "milk"] },
  "Buffalo Chicken Breast":        { cal: 580,  protein: 36, carbs: 52, tags: ["HOT"],       allergens: ["wheat", "milk", "eggs"] },
  "Crispy Chicken":                { cal: 600,  protein: 34, carbs: 54, allergens: ["wheat", "eggs"] },
  "Grilled Sausage & Peppers":     { cal: 620,  protein: 26, carbs: 50, allergens: ["wheat"] },
  "California Turkey":             { cal: 520,  protein: 28, carbs: 48, allergens: ["wheat", "milk"] },
  "Philly Steak Bomb":             { cal: 760,  protein: 38, carbs: 62, tags: ["BEST"],      allergens: ["wheat", "milk"] },
  "Watertown":                     { cal: 580,  protein: 28, carbs: 52, allergens: ["wheat", "milk"] },
  "Newton":                        { cal: 560,  protein: 26, carbs: 50, allergens: ["wheat", "milk"] },
  "Meatball Parmigiana":           { cal: 680,  protein: 32, carbs: 68, allergens: ["wheat", "milk", "eggs"] },
  "Meatball & Sausage Parmigiana": { cal: 740,  protein: 36, carbs: 72, allergens: ["wheat", "milk", "eggs"] },
  "Eggplant Parmigiana Sub":       { cal: 580,  protein: 18, carbs: 64, tags: ["V"],         allergens: ["wheat", "milk", "eggs"] },
  "Beef or Chicken Philly":        { cal: 680,  protein: 38, carbs: 58, allergens: ["wheat", "milk"] },

  // ── WRAPS ────────────────────────────────────────────────────
  "Grilled Chicken Caesar":        { cal: 520,  protein: 36, carbs: 44,  allergens: ["wheat", "milk", "eggs", "fish"] },
  "Crispy Chicken Wrap":           { cal: 560,  protein: 34, carbs: 48,  allergens: ["wheat", "eggs"] },
  "Buffalo Chicken Wrap":          { cal: 580,  protein: 36, carbs: 46,  tags: ["HOT"],       allergens: ["wheat", "milk", "eggs"] },
  "Veggie":                        { cal: 380,  protein: 12, carbs: 50,  tags: ["V"],         allergens: ["wheat", "milk"] },
  "Steak":                         { cal: 620,  protein: 40, carbs: 44,  allergens: ["wheat", "milk"] },

  // ── BURGERS ──────────────────────────────────────────────────
  "Hamburger":                     { cal: 580,  protein: 32, carbs: 42,  allergens: ["wheat", "eggs", "milk"] },
  "Cheeseburger":                  { cal: 640,  protein: 36, carbs: 42,  tags: ["BEST"],      allergens: ["wheat", "eggs", "milk"] },
  "Bacon Burger":                  { cal: 680,  protein: 38, carbs: 42,  allergens: ["wheat", "eggs", "milk"] },
  "Chili Cheese":                  { cal: 760,  protein: 40, carbs: 50,  allergens: ["wheat", "eggs", "milk"] },
  "Blue Beef & Cheese":            { cal: 720,  protein: 38, carbs: 42,  allergens: ["wheat", "eggs", "milk"] },
  "Crispy Chicken Burger":         { cal: 680,  protein: 36, carbs: 52,  allergens: ["wheat", "eggs", "milk"] },
  "Bacon Cheeseburger":            { cal: 740,  protein: 42, carbs: 42,  allergens: ["wheat", "eggs", "milk"] },
  "Napoli Cheeseburger":           { cal: 760,  protein: 42, carbs: 44,  tags: ["BEST"],      allergens: ["wheat", "eggs", "milk"] },
